...
const file_orders_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\x06.OrderR\x06orders2y\n" +
	"\fOrderService\x128\n" +
	"\vCreateOrder\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponse\x12/\n" +
	"\bGetOrder\x12\x10.GetOrderRequest\x1a\x11.GetOrderResponseB(Z&github.com/preetDev004/gRPC-ISC/ordersb\x06proto3"
